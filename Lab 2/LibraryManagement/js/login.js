...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const usernameInput = document.querySelector('.input-username') || document.getElementById('username');
    const passwordInput = document.querySelector('.input-password') || document.getElementById('password');
